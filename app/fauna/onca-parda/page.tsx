    ...
    <div className="bg-white text-onca-preto selection:bg-onca-laranja selection:text-onca-preto">
      ...
      <section className="bg-gray-50 py-16 min-[2000px]:py-32 border-y border-gray-200">
        <div className="mx-auto max-w-5xl min-[2000px]:max-w-400 px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 min-[2000px]:gap-12">
            <div className="bg-white p-6 min-[2000px]:p-12 rounded-2xl min-[2000px]:rounded-[2.5rem] shadow-sm border border-gray-100 flex flex-col gap-3 min-[2000px]:gap-6">
              ...
              <p className="text-gray-700 font-medium text-lg min-[2000px]:text-3xl">
                38 kg a 72 kg
              </p>
            </div>
            ...
            <div className="bg-white p-6 min-[2000px]:p-12 rounded-2xl min-[2000px]:rounded-[2.5rem] shadow-sm border border-gray-100 flex flex-col gap-3 min-[2000px]:gap-6">
              <div className="flex items-center gap-2 min-[2000px]:gap-4 text-onca-laranja-escuro font-bold uppercase tracking-widest text-sm min-[2000px]:text-2xl">
                <Globe2 className="w-5 h-5 min-[2000px]:w-8 min-[2000px]:h-8" />{' '}
                Status
              </div>
              <p className="text-green-600 font-bold uppercase text-sm min-[2000px]:text-2xl mt-1">
                Pouco Preocupante
              </p>
            </div>
          </div>
      ...
      <section className="mx-auto max-w-5xl min-[2000px]:max-w-400 px-6 py-20 min-[2000px]:py-40">
      ...
      <section className="bg-gray-50 py-24 min-[2000px]:py-48 border-y border-gray-200">
        <div className="mx-auto max-w-5xl min-[2000px]:max-w-400 px-6">
          <div className="grid md:grid-cols-12 gap-12 lg:gap-16 min-[2000px]:gap-32 items-start">
            <div className="md:col-span-7 space-y-6 min-[2000px]:space-y-12 text-lg min-[2000px]:text-3xl text-gray-700 leading-relaxed min-[2000px]:leading-normal">
              <h3 className="text-3xl min-[2000px]:text-6xl font-bold uppercase tracking-tight text-onca-preto border-l-4 min-[2000px]:border-l-8 border-onca-laranja pl-4 min-[2000px]:pl-8">
                Ecologia e Hábitat
              </h3>
            ...
            <div className="lg:mt-18 min-[2000px]:mt-36 md:col-span-5 space-y-4 min-[2000px]:space-y-8">
              <div
                className="relative w-full aspect-video rounded-2xl min-[2000px]:rounded-4xl overflow-hidden shadow-md cursor-zoom-in group"
                onClick={() =>
                  setModalData({
              ...
              <p className="text-xs min-[2000px]:text-2xl text-gray-500 text-center italic pt-2 min-[2000px]:pt-4">
      ...
      <section className="bg-onca-preto text-white py-24 min-[2000px]:py-48">
        <div className="mx-auto max-w-6xl min-[2000px]:max-w-400 px-6 space-y-16 min-[2000px]:space-y-32">
          <div className="grid md:grid-cols-2 gap-12 lg:gap-20 min-[2000px]:gap-40 items-start">
            <div className="space-y-6 min-[2000px]:space-y-12">
              <h3 className="text-3xl min-[2000px]:text-6xl font-bold uppercase tracking-tight text-onca-laranja">
              ...
              <p className="text-gray-200 leading-relaxed min-[2000px]:leading-normal font-medium border-l-2 min-[2000px]:border-l-4 border-onca-laranja pl-6 min-[2000px]:pl-12 text-lg min-[2000px]:text-3xl">
            ...
            <div className="bg-white/5 border border-white/10 rounded-3xl min-[2000px]:rounded-[3rem] p-8 lg:p-10 min-[2000px]:p-20 backdrop-blur-sm">
              <h4 className="flex items-center gap-3 min-[2000px]:gap-6 text-2xl min-[2000px]:text-5xl font-bold uppercase tracking-tight text-red-500 mb-8 min-[2000px]:mb-16">
                <ShieldAlert className="w-7 h-7 min-[2000px]:w-14 min-[2000px]:h-14" />{' '}
                Principais Ameaças
              </h4>
              <ul className="space-y-5 min-[2000px]:space-y-10 text-gray-200 font-medium text-lg min-[2000px]:text-3xl">
                <li className="flex items-center gap-4 min-[2000px]:gap-8">
                  <AlertTriangle className="text-onca-laranja shrink-0 w-5 h-5 min-[2000px]:w-10 min-[2000px]:h-10" />
      ...
      <section className="bg-white py-24 min-[2000px]:py-48">
        <div className="mx-auto max-w-5xl min-[2000px]:max-w-400 px-6">
          <div className="bg-onca-laranja text-onca-preto rounded-[2.5rem] min-[2000px]:rounded-[5rem] p-10 md:p-16 min-[2000px]:p-32 flex flex-col md:flex-row items-center justify-between gap-8 min-[2000px]:gap-16 text-center md:text-left relative overflow-hidden group shadow-xl min-[2000px]:shadow-2xl">
            <div className="absolute -right-20 -top-20 w-80 h-80 min-[2000px]:w-150 min-[2000px]:h-150 bg-white/30 rounded-full blur-3xl min-[2000px]:blur-[100px] pointer-events-none group-hover:scale-125 transition-transform duration-700" />
            <div className="absolute -left-20 -bottom-20 w-64 h-64 min-[2000px]:w-125 min-[2000px]:h-125 bg-white/20 rounded-full blur-3xl min-[2000px]:blur-[100px] pointer-events-none" />
