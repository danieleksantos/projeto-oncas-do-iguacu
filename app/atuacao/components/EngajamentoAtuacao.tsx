...
export default function EngajamentoAtuacao() {
  ...
  return (
    <>
      ...
      <section className="w-full py-24 bg-gray-50 text-onca-preto border-y border-gray-200">
            ...
            <div className="order-1 lg:order-2 space-y-6">
              ...
              <div className="bg-white/5 border border-white/10 p-6 sm:p-8 rounded-3xl mt-8 backdrop-blur-sm">
                ...
                <p className="text-gray-300 leading-relaxed">
                  ...
                  no Parque Nacional. Eles atuam como os "olhos" do projeto em
                  campo, contribuindo com registros frequentes, vídeos e
                  informações sobre a presença dos animais. Essa troca direta
                  fortalece o monitoramento científico e cria um forte senso de
                  pertencimento.
                </p>
              </div>
            </div>
